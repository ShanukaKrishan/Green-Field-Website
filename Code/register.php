...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM farmer WHERE username = ?";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO farmer (username, password, nic,name) VALUES (?, ?, ?, ?)";
...
<head>
    ...
    <style type="text/css">
        body{ font: 14px sans-serif;background:url(farmerreg.jpg);background-size:100%; }
...
<body>
    <div class="wrapper">
        <h2 style="color: white;">Sign Up New Farmer</h2>
