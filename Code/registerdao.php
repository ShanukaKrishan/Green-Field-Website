...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM dao WHERE username = ?";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO dao (username, password, nic,name) VALUES (?, ?, ?, ?)";
...
<head>
    ...
    <style type="text/css">
        body{ font: 14px sans-serif;background:url(daobuild.jpg);background-size:100%; }
