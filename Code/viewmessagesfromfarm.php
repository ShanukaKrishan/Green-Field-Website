...
<head>
	...
	<a href="keels.php"><img src=back.png height="40px" width="40px"></a>
	</center>
	<style type="text/css">
#customers {
...
<h2 style="text-align: center;">Messages from farmers</h2>
...
<?php
	...
	$sql = "SELECT * FROM farmmsg Where keelsuname='$username'";
...
while ($row = mysqli_fetch_array($results)) {
  echo "<h3>Product Name : ".$row['name']."</h3>";
    ...
    echo "<center>";
    echo "<a id='replybtn' href='message.php?suname=".$row['keelsuname']."&name=".$row['name']."&username=".$_SESSION["username"]."'>Send a Reply to the message</a>" ;
   echo "<br>";echo "<br>";
    echo "<p> -----------------------------------------------------------------------------------------------------------------</p>";
echo "</center>";
